        ...
        <div class="col-xxl">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Agregar empleado</h5> <small class="text-muted float-end"><span
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('empleados.store') }}" method="POST" id="form-puesto-store">
                        @csrf
                        <div class="row mb-3">
                            <!-- Nombre -->
                        ...
                        <div class="row mb-3 pe-0">
                            ...
                            <div class="col-md-4 col-12 pe-0">
                                ...
                                <div class="input-group input-group-merge @error('correo') is-invalid @enderror">
                                    ...
                                    <input type="email" id="correo" value="{{old('correo')}}"
                                ...
                                <div class="input-group input-group-merge @error('company') is-invalid @enderror">
                                    ...
                                    <select id="company"
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}" {{old('company') == $company->id ? 'selected' : ''}}>{{ $company->alias }}
                                                [{{ $company->name }}]
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4 col-12 pe-0">
                                ...
                                <div class="input-group input-group-merge @error('fecha_ingreso') is-invalid @enderror">
                                    <input class="form-control @error('fecha_ingreso') is-invalid @enderror" type="date"
                                           id="fecha-ingreso" value="{{old('fecha_ingreso')}}"
                                    ...
                                    <select id="puesto" name="puesto"
                                        ...
                                        @foreach($puestos as $puesto)
                                            <option value="{{ $puesto->id }}"
                                                    {{old('puesto') == $puesto->id ? 'selected' : ''}}>{{ $puesto->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('puesto')
